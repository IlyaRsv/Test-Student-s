...
function sigmaX() {
	...
	resultSigmaX.textContent = `${arithmeticMeanX.toFixed(1)} ± ${sigmaX.toFixed(
		1
	)}`
	console.log(
...
function sigmaY() {
	...
	resultSigmaY.textContent = `${arithmeticMeanY.toFixed(1)} ± ${sigmaY.toFixed(
		1
	)}`
	console.log(
...
function addInputs() {
	let inputLeft = '<input class="input-left" inputmode="decimal" type="text"/>'
	let inputRight =
